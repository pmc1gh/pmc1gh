...
/*************** END GAUSSIAN ******************/
    ...
    cudaMalloc(&dev_input_data, padded_length * sizeof(cufftComplex));
    cudaMalloc(&dev_impulse_v, padded_length * sizeof(cufftComplex));
    cudaMalloc(&dev_out_data, padded_length * sizeof(cufftComplex));
...
#define STOP_RECORD_TIMER(name) {                           \
    ...
    for (int ch = 0; ch < nChannels; ch++){
        ...
        */
        ...
        cudaMemcpy(dev_impulse_v, impulse_data, impulse_length * sizeof(cufftComplex),
                   cudaMemcpyHostToDevice);
        ...
        */
        ...
        cudaMemset(dev_input_data + N, 0,
                   (padded_length - N) * sizeof(cufftComplex));
        cudaMemset(dev_impulse_v + impulse_length, 0,
        ...
        */
        ...
        // Allocate memory for arrays that are used in the reduction process.
        cufftComplex *dev_out_data_copy;
        cudaMalloc(&dev_out_data_copy, padded_length * sizeof(cufftComplex));
        cudaMemcpy(dev_out_data_copy, dev_out_data,
                   padded_length * sizeof(cufftComplex), cudaMemcpyDeviceToDevice);

        cufftComplex *dev_max_data;
        cudaMalloc(&dev_max_data, padded_length * sizeof(cufftComplex));
        cudaMemset(dev_max_data, 0, padded_length * sizeof(cufftComplex));
        ...
        cudaCallMaximumKernel(blocks, local_size, dev_out_data_copy,
            dev_max_data, dev_max_abs_val, padded_length);
        ...
        cudaMemcpy(output_data, dev_out_data,
